...
constructor(x, y) {
       const sprite = new Sprite(assets.get('zigoku'), new Rectangle(0, 0, 600, 1200));
       const hitArea = new Rectangle(0, 0, 0, 0);
...
class Enemy extends SpriteActor {
    constructor(x, y) {
        const sprite = new Sprite(assets.get('maou'), new Rectangle(0, 0, 64, 64));
